...
<div style="text-align: center; font-size: 18px;">
  ...
  (https://github.com/henry-AY/STAT107_Team_23_World_Cup)
</div>
...
```{r, echo = FALSE, warning = FALSE, out.width="65%", fig.align='center'}
...
### Random Forest 
```{r, warning=FALSE, echo=FALSE, out.width="85%", fig.align='center'}
source("04_model_bias.R")
plot_pred_vs_actual(results$predictions)
```
...
* Refugio Zepeda (25% Data Preprocessing)
